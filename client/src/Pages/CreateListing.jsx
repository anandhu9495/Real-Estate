    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <p className='font-sembold'>Images : 
                <span className='font-normal text-gray-600 ml-2'>The First will be Cover (max 6)</span>
                </p>

                <div className='flex gap-4'>
                    <input onClick={(e) => setFiles(e.target.files)} className='p-3 border border-grey-300 rounded w-full' type="file" id='images' accept='image/*' multiple/>
